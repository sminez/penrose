...
impl ClientMessageKind {
    ...
    /// explicitly.
    pub fn as_message<X>(&self, q: &X) -> ClientMessage
    where
        X: XConn,
    {
        let proto_msg = |id: Xid, atom: Atom| {
            ...
            ClientMessage::new(id, mask, proto, data.into())
        };
        ...
        let xembed_msg = |id: Xid, embedder: Xid, kind: u32| {
            ...
            ClientMessage::new(id, mask, atom, data.into())
        };
        ...
        match self {
            ...
            ClientMessageKind::TakeSystrayOwnership(root_id, systray_id) => {
                ...
                ClientMessage::new(*root_id, mask, atom, data.into())
            }
