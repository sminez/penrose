...
impl ResizeSurfaceGrab {
    pub fn start(
        ...
        ResizeSurfaceState::with(win.toplevel().wl_surface(), |state| {
...
impl PointerGrab<WaylandState> for ResizeSurfaceGrab {
    ...
    fn motion(
        ...
        let (min_size, max_size) = with_states(self.win.toplevel().wl_surface(), |states| {
...
pub(crate) fn handle_resize_grab_commit(
